...
export const modules = [
  ...
  { week: 3, chapter: 3, title: 'R 数据可视化与词云', description: '使用图形理解数据规律，并借助中文分词完成词云练习。', status: '含练习', items: ['描述分析与常用图形', '单变量与多变量可视化', '中文分词与词云实验'] },
  ...
  { week: 5, chapter: 5, title: 'Pandas 与透视表实践', description: '完成数据读取、清洗、连接、汇总，并使用 Tips 与 Titanic 数据练习。', status: '含数据与代码', items: ['Pandas 数据框与外部数据', '数据清洗、合并与汇总', '透视表作业与 Notebook'] },
  { week: 6, chapter: 6, title: '集成学习算法', description: '从决策树出发，理解随机森林与 Boosting 的组合建模思路。', status: '资料齐全', items: ['决策树', '随机森林', 'Boosting'] },
  { week: 7, chapter: 7, title: '静态网页爬虫', description: '学习 HTTP 请求、requests、lxml 与 BeautifulSoup，并完成豆瓣电影任务。', status: '含作业', items: ['爬虫的“抓、析、存”流程', 'requests 与页面解析', '豆瓣电影静态爬虫练习'] },
