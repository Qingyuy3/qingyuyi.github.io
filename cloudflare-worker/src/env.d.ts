/* eslint-disable */
// Generated by Wrangler by running `wrangler types cloudflare-worker/src/env.d.ts --config cloudflare-worker/wrangler.jsonc` (hash: 44a9ab02e9eb9715f77ceb26ac264015)
// Runtime types generated with workerd@1.20260515.1 2026-09-02 nodejs_compat
interface __BaseEnv_Env {
	COURSE_TA_RATE_LIMITER: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEEPSEEK_MODEL" | "DEEPSEEK_API_KEY">> {}
}
