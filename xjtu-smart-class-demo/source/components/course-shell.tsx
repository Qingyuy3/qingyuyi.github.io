...
export function CourseShell() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <header className="sticky top-0 z-30 border-b border-t-4 border-border/70 border-t-brand-red bg-background/95 backdrop-blur-xl">
