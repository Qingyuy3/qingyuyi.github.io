/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=learning-platform/wrangler.local.jsonc --env-interface=PlatformEnv learning-platform/env.d.ts` (hash: 24e3021db5402fd54458454d6da2d122)
// Runtime types generated with workerd@1.20260831.1 2026-09-04 nodejs_compat
interface __BaseEnv_PlatformEnv {
	FILES: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	PUBLIC_ORIGIN: "http://localhost:8790";
	AUTH_SECRET: string;
	TA_WORKER: Fetcher /* xjtu-course-ta */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./dist/_worker");
	}
	interface Env extends __BaseEnv_PlatformEnv {}
}
interface PlatformEnv extends __BaseEnv_PlatformEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ORIGIN" | "AUTH_SECRET">> {}
}
